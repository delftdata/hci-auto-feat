...
class FeatureDiscovery:
    ...
    def remove_join_path_from_tree(self, tree_id: int, table: str):
        tree_functions.remove_join_from_path(self, tree_id, table)
    ...
    def inspect_join_tree(self, tree_id: int):
        tree_functions.inspect_join_path(self, tree_id)

    def evaluate_paths(self, algorithm='GBM', top_k_paths: int = 2, verbose=True, explain=False):
    ...
    def materialise_join_tree(self, tree_id: int):
        return tree_functions.materialise_join_path(self, tree_id)
